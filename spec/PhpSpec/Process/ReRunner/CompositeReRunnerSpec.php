...
{
    public function let(PlatformSpecificReRunner $reRunner1, PlatformSpecificReRunner $reRunner2)
    {
    ...
    public function it_invokes_the_first_supported_child_to_rerun_the_suite_even_if_later_children_are_supported(
    ...
    public function it_skips_early_child_if_it_is_not_supported_and_invokes_runsuite_on_later_supported_child(
        PlatformSpecificReRunner $reRunner1,
        PlatformSpecificReRunner $reRunner2
    ) {
        $reRunner1->isSupported()->willReturn(false);
