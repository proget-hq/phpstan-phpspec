...
final class IterablesMatcherSpec extends ObjectBehavior
{
    ...
    public function it_should_throw_an_invalid_argument_exception_if_subject_is_not_iterable()
    {
        $this
    ...
    public function it_should_throw_an_invalid_argument_exception_if_expected_value_is_not_iterable()
    {
        $this
    ...
    public function it_should_throw_an_exception_if_subject_has_less_elements_than_expected()
    {
        $this
    ...
    public function it_should_throw_an_exception_if_subject_element_does_not_match_the_expected_one()
    {
        $this
