...
final class TraversableCountMatcherSpec extends ObjectBehavior
{
    ...
    public function it_positive_matches_proper_generator_count()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_does_not_positive_match_infinite_generator()
    {
        $this
    ...
    public function it_does_not_positive_match_wrong_generator_count()
    {
        $this
    ...
    public function it_negative_matches_wrong_generator_count()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_negative_matches_infinite_generator()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_does_not_negative_match_proper_generator_count()
    {
        $this
