...
final class IterateAsMatcherSpec extends ObjectBehavior
{
    ...
    public function it_responds_to_iterate()
    {
    ...
    public function it_positive_matches_generator_while_iterating_the_same()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_negative_matches_generator_while_not_iterating_the_same()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_does_not_negative_matches_generator_while_iterating_the_same()
    {
        $this
