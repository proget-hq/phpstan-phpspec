...
final class TraversableKeyValueMatcherSpec extends ObjectBehavior
{
    ...
    public function it_responds_to_haveKeyWithValue()
    {
        $this->supports('haveKeyWithValue', $this->createGeneratorReturningArray([]), ['', ''])->shouldReturn(true);
    }

    public function it_positive_matches_generator_with_specified_key_and_value()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_does_not_positive_match_generator_without_specified_key_and_value()
    {
        $this
    ...
    public function it_negative_matches_generator_without_specified_key_and_value()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_does_not_negative_matches_generator_with_specified_key_and_value()
    {
        $this
            ->shouldThrow(FailureException::class)
