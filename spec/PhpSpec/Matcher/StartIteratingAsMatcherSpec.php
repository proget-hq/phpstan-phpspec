...
final class StartIteratingAsMatcherSpec extends ObjectBehavior
{
    ...
    public function it_responds_to_startIterating()
    {
    ...
    public function it_positive_matches_generator_while_starting_iterating_the_same()
    {
        $this
            ->shouldNotThrow()
    ...
    public function it_positive_matches_infinite_generator_while_starting_iterating_the_same()
    {
        $this
            ->shouldNotThrow()
            ->during('positiveMatch', [
    ...
    public function it_does_not_positive_match_generator_while_not_starting_iterating_the_same()
    {
        $this
    ...
    public function it_negative_matches_infinite_generator_while_not_starting_iterating_the_same()
    {
        $this
            ->shouldNotThrow()
            ->during('negativeMatch', [
    ...
    public function it_does_not_negative_matches_generator_while_starting_iterating_the_same()
    {
        $this
