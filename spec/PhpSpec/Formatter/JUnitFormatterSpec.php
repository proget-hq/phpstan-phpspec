...
class JUnitFormatterSpec extends ObjectBehavior
{
    ...
    public function it_stores_a_testcase_node_after_passed_example_run(
        ExampleEvent $event,
    ...
    public function it_stores_a_testcase_node_after_broken_example_run(
        ExampleEvent $event,
        SpecificationNode $specification,
        \ReflectionClass $refClass
    ) {
    ...
    public function it_stores_a_testcase_node_after_failed_example_run(
        ExampleEvent $event,
        SpecificationNode $specification,
        \ReflectionClass $refClass
    ) {
    ...
    public function it_stores_a_testcase_node_after_skipped_example_run(
        ExampleEvent $event,
        SpecificationNode $specification,
        \ReflectionClass $refClass
    ) {
    ...
    public function it_aggregates_testcase_nodes_and_store_them_after_specification_run(SpecificationEvent $event)
    {
        $event->getTitle()->willReturn('specification title');
        $event->getTime()->willReturn(42);

        $this->setTestCaseNodes([
            '<testcase name="example1" />',
            '<testcase name="example2" />',
            '<testcase name="example3" />',
        ]);

        $this->setExampleStatusCounts([
        ...
        $this->getExampleStatusCounts()->shouldReturn([
    ...
    public function it_aggregates_testsuite_nodes_and_display_them_after_suite_run(SuiteEvent $event, $io, $stats)
    {
