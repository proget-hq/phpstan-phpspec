...
class DotFormatterSpec extends ObjectBehavior
{
    ...
    public function it_is_a_console_formatter()
    {
        $this->shouldHaveType('PhpSpec\Formatter\ConsoleFormatter');
    }

    public function it_outputs_a_dot_for_a_passed_example(
        ExampleEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
    ...
    public function it_outputs_a_p_for_a_pending_example(
        ExampleEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
    ...
    public function it_outputs_an_s_for_a_skipped_example(
        ExampleEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
    ...
    public function it_outputs_an_f_for_a_failed_example(
        ExampleEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
    ...
    public function it_outputs_a_b_for_a_broken_example(
        ExampleEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
    ...
    public function it_outputs_the_progress_every_50_examples(
    ...
    public function it_outputs_exceptions_for_failed_examples(
        SuiteEvent $event,
    ...
    public function it_outputs_a_suite_summary(
        SuiteEvent $event,
        ConsoleIO $io,
        StatisticsCollector $stats
    ) {
