...
{
    public function let(StringTypePresenter $stringTypePresenter)
    {
    ...
    public function it_should_support_string_values(StringTypePresenter $stringTypePresenter)
    {
    ...
    public function it_should_return_long_values_truncated(
        StringTypePresenter $stringTypePresenter
    ) {
    ...
    public function it_presents_only_first_line_of_multiline_string(StringTypePresenter $stringTypePresenter)
    {
