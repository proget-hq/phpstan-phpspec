...
{
    public function it_is_a_value_presenter()
    {
        $this->shouldHaveType('PhpSpec\Formatter\Presenter\Value\ComposedValuePresenter');
    }

    public function it_should_accept_a_type_presenter(TypePresenter $typePresenter)
    {
        $this->addTypePresenter($typePresenter)->shouldReturn(null);
    }

    public function it_should_call_supports_on_value_presenters_until_one_returns_true(
        TypePresenter $presenter1,
        TypePresenter $presenter2,
        TypePresenter $presenter3
    ) {
        $value = 'blah';
    ...
    public function it_should_order_presenters_by_their_priority_in_descending_order(
        TypePresenter $presenter1,
        TypePresenter $presenter2
    ) {
        $value = 'foo';
    ...
    public function it_should_call_present_on_a_supporting_type_presenter(TypePresenter $typePresenter)
    {
        $value = 'blah';
    ...
    public function it_should_return_the_type_presenter_presented_value(TypePresenter $typePresenter)
    {
        $value = 'blah';
    ...
    public function it_should_present_a_simple_type_as_typed_value()
    {
