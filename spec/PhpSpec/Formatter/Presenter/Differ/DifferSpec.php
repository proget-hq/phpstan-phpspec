...
{
    public function it_chooses_proper_engine_based_on_values(
        DifferEngine $engine1,
        DifferEngine $engine2
    ) {
    ...
    public function it_returns_null_if_engine_not_found()
    {
        $this->compare(1, 2)->shouldReturn(null);
    }

    public function its_constructor_allows_a_list_of_engines(DifferEngine $engine)
    {
