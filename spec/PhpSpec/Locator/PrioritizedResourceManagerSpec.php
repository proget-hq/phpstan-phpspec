...
{
    public function let(ResourceLocator $locator1, ResourceLocator $locator2)
    {
        $locator1->getPriority()->willReturn(5);
        $locator2->getPriority()->willReturn(10);
    }

    public function it_locates_resources_using_all_registered_locators(
        $locator1,
        $locator2,
        Resource $resource1,
        Resource $resource2,
        ...
        $locator1->findResources('s:query')->willReturn([$resource3, $resource2]);
        $locator2->supportsQuery('s:query')->willReturn(true);
        $locator2->findResources('s:query')->willReturn([$resource1]);
        ...
        $this->locateResources('s:query')->shouldReturn([$resource1, $resource3, $resource2]);
    }
    ...
    public function it_locates_all_locators_resources_if_query_string_is_empty(
        ...
        $locator1->getAllResources()->willReturn([$resource3, $resource2]);
        $locator2->getAllResources()->willReturn([$resource1]);

        $resource1->getSpecClassname()->willReturn('Some\Spec1');
        $resource2->getSpecClassname()->willReturn('Some\Spec2');
        $resource3->getSpecClassname()->willReturn('Some\Spec3');

        $this->locateResources('')->shouldReturn([$resource1, $resource3, $resource2]);
    }

    public function it_returns_empty_array_if_registered_locators_do_not_support_query($locator1)
    {
        $this->registerLocator($locator1);
        ...
        $this->locateResources('s:query')->shouldReturn([]);
    }

    public function it_creates_resource_from_classname_using_locator_with_highest_priority(
        $locator1,
        $locator2,
        Resource $resource1,
        Resource $resource2
    ...
    public function it_throws_an_exception_if_locators_do_not_support_classname($locator1)
    {
        $this->registerLocator($locator1);
    ...
    public function it_does_not_allow_two_resources_for_the_same_spec(
        $locator1,
        $locator2,
        Resource $resource1,
        Resource $resource2
        ...
        $locator1->getAllResources()->willReturn([$resource1]);
        $locator2->getAllResources()->willReturn([$resource2]);

        $this->locateResources('')->shouldReturn([$resource2]);
    }

    public function it_uses_the_resource_from_the_highest_priority_locator_when_duplicates_occur(
        $locator1,
        $locator2,
        Resource $resource1,
        Resource $resource2
        ...
        $this->locateResources('')->shouldReturn([$resource1]);
    }
}
