...
class PSR0LocatorSpec extends ObjectBehavior
{
    ...
    {
        $this->srcPath = realpath(__DIR__.'/../../../../vendor/phpspec/phpspec/src');
        $this->specPath = realpath(__DIR__.'/../../../../');

        $this->beConstructedWith($fs);
    }

    public function it_is_a_locator()
    {
        $this->shouldBeAnInstanceOf('PhpSpec\Locator\ResourceLocator');
    }

    public function its_priority_is_zero()
    {
        $this->getPriority()->shouldReturn(0);
    }

    public function it_generates_fullSrcPath_from_srcPath_plus_namespace(Filesystem $fs)
    {
    ...
    public function it_generates_fullSrcPath_from_srcPath_plus_namespace_cutting_psr4_prefix(Filesystem $fs)
    {
    ...
    public function it_generates_proper_fullSrcPath_even_from_empty_namespace(Filesystem $fs)
    {
    ...
    public function it_should_not_have_backslash_on_missing_prefix(Filesystem $fs)
    {
    ...
    public function it_generates_fullSpecPath_from_specPath_plus_namespace(Filesystem $fs)
    {
    ...
    public function it_generates_fullSpecPath_from_specPath_plus_namespace_cutting_psr4_prefix(Filesystem $fs)
    {
    ...
    public function it_generates_proper_fullSpecPath_even_from_empty_src_namespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', dirname(__DIR__), __DIR__);
    ...
    public function it_stores_srcNamespace_it_was_constructed_with(Filesystem $fs)
    {
    ...
    public function it_trims_srcNamespace_during_construction(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '\\Some\Namespace\\', 'spec', dirname(__DIR__), __DIR__);
    ...
    public function it_supports_empty_namespace_argument(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', dirname(__DIR__), __DIR__);
    ...
    public function it_generates_specNamespace_using_srcNamespace_and_specPrefix(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'Some\Namespace', 'spec', dirname(__DIR__), __DIR__);
    ...
    public function it_trims_specNamespace_during_construction(Filesystem $fs)
    {
    ...
    public function it_generates_proper_specNamespace_for_empty_srcNamespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', dirname(__DIR__), __DIR__);
    ...
    public function it_finds_all_resources_from_tracked_specPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, '', 'spec', dirname(__DIR__), __DIR__);
        ...
        $fs->findSpecFilesIn($path)->willReturn([$file]);
    ...
    public function it_returns_empty_array_if_tracked_specPath_does_not_exist(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', dirname(__DIR__), __DIR__);
        $path = __DIR__.DIRECTORY_SEPARATOR.'spec'.DIRECTORY_SEPARATOR;
    ...
    public function it_supports_folder_queries_in_srcPath(Filesystem $fs)
    {
    ...
    public function it_supports_srcPath_queries(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_file_queries_in_srcPath(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_folder_queries_in_specPath(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_specPath_queries(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_file_queries_in_specPath(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_does_not_support_any_other_queries(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_finds_spec_resources_via_srcPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
        ...
        $fs->findSpecFilesIn($this->specPath.$this->convert_to_path('/spec/PhpSpec/'))->willReturn([$file]);
    ...
    public function it_finds_spec_resources_with_classname_underscores_via_srcPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_finds_spec_resources_via_fullSrcPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
        ...
        $fs->findSpecFilesIn($this->specPath.$this->convert_to_path('/spec/PhpSpec/Console/'))->willReturn([$file]);
    ...
    public function it_finds_spec_resources_via_specPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
        ...
        $fs->findSpecFilesIn($this->specPath.$this->convert_to_path('/spec/PhpSpec/Runner/'))->willReturn([$file]);
    ...
    public function it_finds_single_spec_via_srcPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_finds_single_spec_via_specPath(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_returns_empty_array_if_nothing_found(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_no_class_definition(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_does_not_throw_an_exception_on_no_class_definition_if_file_not_suffixed_with_spec(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
        ...
        $fs->pathExists($this->specPath.$this->convert_to_path('/spec/PhpSpec/'))->willReturn(true);
        $fs->findSpecFilesIn($this->specPath.$this->convert_to_path('/spec/PhpSpec/'))->willReturn([]);
        $fs->getFileContents($filePath)->willReturn('no class definition');
        $file->getRealPath()->willReturn($filePath);
    ...
    public function it_throws_an_exception_when_spec_class_not_in_the_base_specs_namespace(Filesystem $fs, SplFileInfo $file)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_classes_from_srcNamespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_backslashed_classes_from_srcNamespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_classes_from_specNamespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_backslashed_classes_from_specNamespace(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_supports_any_class_if_srcNamespace_is_empty(Filesystem $fs)
    {
    ...
    public function it_does_not_support_anything_else(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_src_class(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_backslashed_src_class(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_spec_class(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_backslashed_spec_class(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_src_class_even_if_srcNamespace_is_empty(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_creates_resource_from_spec_class_with_leading_backslash(Filesystem $fs)
    {
        $this->beConstructedWith($fs, 'PhpSpec', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_non_PSR0_resource(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_PSR0_resource_with_double_backslash(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_PSR0_resource_with_slash_on_the_end(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_PSR0_resource_with_line_breaks_at_end(Filesystem $fs)
    {
        $this->beConstructedWith($fs, '', 'spec', $this->srcPath, $this->specPath);
    ...
    public function it_throws_an_exception_on_PSR4_prefix_not_matching_namespace(Filesystem $fs)
    {
        $exception = new \InvalidArgumentException(
            'PSR4 prefix doesn\'t match given class namespace.'.PHP_EOL
        );

        $this->shouldThrow($exception)->during('__construct', [$fs, 'p\pf\N\S', 'spec', $this->srcPath, $this->specPath, 'wrong\prefix']);
    }

    public function it_supports_psr0_namespace_queries(Filesystem $filesystem)
    {
    ...
    public function it_supports_psr0_namespace_queries_with_a_namespace_prefix(Filesystem $filesystem)
    {
    ...
    public function it_supports_psr4_namespace_queries(Filesystem $filesystem)
    {
