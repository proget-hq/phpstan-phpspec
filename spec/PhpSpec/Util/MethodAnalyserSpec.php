...
{
    public function it_identifies_empty_methods_as_empty()
    {
    ...
    public function it_identifies_commented_methods_as_empty()
    {
        $this->methodIsEmpty('spec\PhpSpec\Util\ExampleObject', 'commentedMethod')->shouldReturn(true);
    }

    public function it_identifies_methods_with_code_as_not_empty()
    {
        $this->methodIsEmpty('spec\PhpSpec\Util\ExampleObject', 'nonEmptyMethod')->shouldReturn(false);
    }

    public function it_identifies_methods_without_standard_braces_as_non_empty()
    {
    ...
    public function it_identifies_internal_classes_as_non_empty()
    {
        $this->methodIsEmpty('DateTimeZone', 'getOffset')->shouldReturn(false);
    }

    public function it_identifies_methods_from_traits()
    {
    ...
    public function it_finds_the_real_declaring_class_of_a_method()
    {
