...
{
    public function it_should_return_the_line_number_of_the_start_of_the_first_method()
    {
        $class = $this->getSingleMethodClass();
        $this->getStartLineOfFirstMethod($class)->shouldReturn(7);
    }

    public function it_should_detect_if_class_has_a_method()
    {
        $class = $this->getSingleMethodClass();
    ...
    public function it_should_return_the_line_number_of_the_end_of_the_named_method()
    {
        $class = $this->getSingleMethodClass();
        $this->getEndLineOfNamedMethod($class, 'methodOne')->shouldReturn(13);
    }

    public function it_should_return_the_line_number_of_the_end_of_the_last_method()
    {
