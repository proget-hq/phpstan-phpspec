...
class CollaboratorMethodNotFoundListenerSpec extends ObjectBehavior
{
    ...
    public function it_listens_to_afterexample_events()
    {
    ...
    public function it_does_not_prompt_when_no_exception_is_thrown(ConsoleIO $io, ExampleEvent $event, SuiteEvent $suiteEvent)
    {
    ...
    public function it_prompts_the_user_when_a_prophecy_method_exception_is_thrown(
        ConsoleIO $io,
        ExampleEvent $event,
    ...
    public function it_does_not_prompt_when_wrong_exception_is_thrown(ConsoleIO $io, ExampleEvent $event, SuiteEvent $suiteEvent)
    {
    ...
    public function it_does_not_prompt_when_collaborator_is_not_an_interface(
        ConsoleIO $io,
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        MethodNotFoundException $exception
    ...
    public function it_does_not_prompt_when_code_generation_is_disabled(
        ConsoleIO $io,
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        MethodNotFoundException $exception
    ...
    public function it_does_not_prompt_if_it_cannot_generate_the_resource(
        ConsoleIO $io,
        ResourceManager $resources,
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
    ...
    public function it_generates_the_method_signature_when_user_says_yes_at_prompt(
        ConsoleIO $io,
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        MethodNotFoundException $exception,
    ...
    public function it_marks_the_suite_as_being_worth_rerunning_when_generation_happens(
        ConsoleIO $io,
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        MethodNotFoundException $exception
    ...
    public function it_warns_if_a_method_name_is_wrong(
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        ConsoleIO $io,
        NameChecker $nameChecker
    ...
    public function it_prompts_and_warns_when_one_method_name_is_correct_but_other_reserved(
        ExampleEvent $event,
        SuiteEvent $suiteEvent,
        ConsoleIO $io,
        NameChecker $nameChecker
