...
class CollaboratorNotFoundListenerSpec extends ObjectBehavior
{
    ...
    public function it_listens_to_afterexample_and_aftersuite_events()
    {
    ...
    public function it_prompts_to_generate_missing_collaborator(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
    ...
    public function it_does_not_prompt_to_generate_when_there_was_no_exception(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
        SuiteEvent $suiteEvent
    ) {
    ...
    public function it_does_not_prompt_to_generate_when_there_was_an_exception_of_the_wrong_type(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
        SuiteEvent $suiteEvent,
    ...
    public function it_does_not_prompt_when_collaborator_is_in_spec_namespace(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
        SuiteEvent $suiteEvent,
        CollaboratorNotFoundException $exception
    ...
    public function it_generates_interface_when_prompt_is_answered_with_yes(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
        SuiteEvent $suiteEvent,
        GeneratorManager $generator,
    ...
    public function it_does_not_generate_interface_when_prompt_is_answered_with_no(
        ConsoleIO $io,
        ExampleEvent $exampleEvent,
        SuiteEvent $suiteEvent,
        GeneratorManager $generator
