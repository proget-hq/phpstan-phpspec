...
class MethodNotFoundListenerSpec extends ObjectBehavior
{
    ...
    public function it_does_not_prompt_for_method_generation_if_non_methodnotfoundexception_was_thrown($exampleEvent, $suiteEvent, $io, \InvalidArgumentException $exception)
    {
    ...
    public function it_does_not_prompt_for_method_generation_if_input_is_not_interactive($exampleEvent, $suiteEvent, $io, MethodNotFoundException $exception)
    {
        $exampleEvent->getException()->willReturn($exception);
    ...
    public function it_warns_when_method_name_is_reserved(
        $exampleEvent,
        $suiteEvent,
        ConsoleIO $io,
        NameChecker $nameChecker
