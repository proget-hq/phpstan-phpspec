...
{
    public function let(NameChecker $classNameChecker, ConsoleIO $io, Generator $originalGenerator)
    {
    ...
    public function it_supports_generation_when_original_generator_supports_it(
    ...
    public function it_does_not_support_generation_when_original_generator_doesnt(
        Generator $originalGenerator,
        Resource $resource
    ) {
    ...
    public function it_delegates_generation_to_original_generator_for_valid_class_name(
        Generator $originalGenerator,
        Resource $resource,
    ...
    public function it_prints_error_and_skips_generation_for_invalid_class_name(
        Generator $originalGenerator,
        Resource $resource,
        NameChecker $classNameChecker,
        ConsoleIO $io
