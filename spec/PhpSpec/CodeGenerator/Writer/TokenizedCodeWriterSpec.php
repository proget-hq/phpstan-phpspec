...
class TokenizedCodeWriterSpec extends ObjectBehavior
{
    ...
    public function it_should_write_the_content_after_the_last_method()
    {
    ...
    public function it_should_write_the_content_before_the_first_method()
    {
        $class = $this->getSingleMethodClass();
        $method = $this->getMethod();
    ...
    public function it_should_write_a_method_after_another_method()
    {
    ...
    public function it_should_handle_no_methods_when_writing_method_at_end()
    {
    ...
    public function it_should_handle_no_methods_when_writing_method_at_start()
    {
        $class = $this->getClassWithNoMethods();
        $method = $this->getMethod();
        $result = $this->getClassWithOnlyNewMethod();
    ...
    public function it_should_throw_an_exception_if_a_specific_method_is_not_found()
    {
        $class = $this->getClassWithNoMethods();

        $exception = new NamedMethodNotFoundException('Target method not found');

        $this->shouldThrow($exception)->during('insertAfterMethod', [$class, 'methodOne', '']);
    }

    public function it_should_generate_a_method_in_a_class_with_a_string_containing_braces()
    {
