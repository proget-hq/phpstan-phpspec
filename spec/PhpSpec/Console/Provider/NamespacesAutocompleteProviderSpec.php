...
{
    public function let(Finder $finder, SrcPathLocator $locator)
    {
        $this->beConstructedWith($finder, [$locator]);
        $locator->getFullSrcPath()->willReturn('/app/src');
    }

    public function it_returns_empty_array_if_nothing_found($finder)
    {
    ...
    public function it_returns_namespaces_from_php_files(
        $finder,
        SplFileInfo $file1,
        SplFileInfo $file2,
        SplFileInfo $file3
