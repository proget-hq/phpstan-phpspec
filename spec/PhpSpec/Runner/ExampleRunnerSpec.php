...
class ExampleRunnerSpec extends ObjectBehavior
{
    ...
    public function it_executes_example_in_newly_created_context(
        ...
        $exampReflection->getParameters()->willReturn([]);
        $exampReflection->invokeArgs($context, [])->shouldBeCalled();

        $this->run($example);
    }

    public function it_dispatches_ExampleEvent_with_pending_status_if_example_is_pending(
        EventDispatcherInterface $dispatcher,
        ExampleNode $example
    ) {
    ...
    public function it_dispatches_ExampleEvent_with_failed_status_if_matcher_throws_exception(
        EventDispatcherInterface $dispatcher,
        ExampleNode $example,
        ReflectionMethod $exampReflection,
        Specification $context
    ...
    public function it_dispatches_ExampleEvent_with_failed_status_if_example_throws_exception(
        EventDispatcherInterface $dispatcher,
        ExampleNode $example,
        ReflectionMethod $exampReflection,
        Specification $context
        ...
        $exampReflection->getParameters()->willReturn([]);
        $exampReflection->invokeArgs($context, [])->willThrow('RuntimeException');
    ...
    public function it_dispatches_ExampleEvent_with_failed_status_if_example_throws_an_error(
        EventDispatcherInterface $dispatcher,
        ExampleNode $example,
        ReflectionMethod $exampReflection,
        Specification $context
        ...
        $exampReflection->getParameters()->willReturn([]);
        $exampReflection->invokeArgs($context, [])->willThrow('Error');
    ...
    public function it_runs_all_supported_maintainers_before_and_after_each_example(
        ExampleNode $example,
        ReflectionMethod $exampReflection,
    ...
    public function it_runs_let_and_letgo_maintainer_before_and_after_each_example_if_the_example_throws_an_exception(
        ExampleNode $example,
        SpecificationNode $specification,
        ReflectionClass $specReflection,
        ReflectionMethod $exampReflection,
